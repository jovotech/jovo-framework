...
class User {
     ...
     */
    updateContext() {
        if (_.get(this, 'config.userContext.prevLength') > 0) {
    ...
    updateContextPrev() {
        ...
        if (_.get(this, 'config.userContext.prev.response.timestamp')) {
        ...
        if (this.context.prev.length === _.get(this, 'config.userContext.prevLength')) {
