...
let RequestBuilderAlexaSkill = require('../platforms/alexa/requestBuilderAlexaSkill').RequestBuilderAlexaSkill;
...
class WebhookTest {
    ...
    testLaunch(launchRequest) {
        if (!launchRequest) {
            launchRequest = (new RequestBuilderAlexaSkill())
                .launchRequest()
                .buildSimple();
        }
    ...
    testIntent(intent) {
        if (typeof intent === 'string') {
            return this.post((new RequestBuilderAlexaSkill())
