...
const BodyTemplate1 = require('./renderTemplate/bodyTemplate1').BodyTemplate1;
const BodyTemplate2 = require('./renderTemplate/bodyTemplate2').BodyTemplate2;
const BodyTemplate3 = require('./renderTemplate/bodyTemplate3').BodyTemplate3;
const BodyTemplate6 = require('./renderTemplate/bodyTemplate6').BodyTemplate6;
const ListTemplate1 = require('./renderTemplate/listTemplate1').ListTemplate1;
const ListTemplate2 = require('./renderTemplate/listTemplate2').ListTemplate2;
const ListTemplate3 = require('./renderTemplate/listTemplate3').ListTemplate3;

const SimpleCard = require('./alexaCards').SimpleCard;
const StandardCard = require('./alexaCards').StandardCard;
const LinkAccountCard = require('./alexaCards').LinkAccountCard;
const AskForListPermissionsCard = require('./alexaCards').AskForListPermissionsCard;
const AskForLocationPermissionsCard = require('./alexaCards').AskForLocationPermissionsCard;
