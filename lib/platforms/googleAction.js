...
class GoogleAction {
    ...
    tell(speech) {
        ...
        this.responseObj.data.google.expected_user_response = false;
        this.responseObj.data.google.rich_response.items.unshift(
            {
                simpleResponse: {
                    ssml: speech,
                },
    ...
    ask(speech, repromptSpeech) {
        this.responseObj.speech = speech;
        this.responseObj.data.google.expected_user_response = true;
        this.responseObj.data.google.rich_response.items.unshift(
            {
                simpleResponse: {
                    ssml: speech,
