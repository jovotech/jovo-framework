            ...
            if (speechText) {
                if (speechText.constructor === Array) {
                    ...
                    for (let text of speechText) {
                        if (this.responseObj.speech === toSSML(text)) {
                            include = true;
                            break;
                        }
                        if (this.responseObj.data.google.richResponse.items[0]
                            .simpleResponse.ssml === toSSML(text)) {
                            include = true;
                            break;
                        }
                    }
        ...
        try {
            ...
            if (repromptText) {
                if (repromptText.constructor === Array) {
                    let include = false;
                    for (let text of repromptText) {
                        if (this.responseObj.data.google.noInputPrompts[0].ssml === toSSML(text)) {
                            include = true;
                            break;
                        }
                    }
