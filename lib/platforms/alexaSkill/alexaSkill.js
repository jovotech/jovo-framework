...
class AlexaSkill extends Platform {
     ...
     * @param {boolean} canUnderstandSlot
     * @param {boolean} canFulfillSlot
     */
    canFulfillSlot(slotName, canUnderstandSlot, canFulfillSlot) {
        if (canUnderstandSlot || canUnderstandSlot === 'YES') {
            canUnderstandSlot = 'YES';
        } else {
            canUnderstandSlot = 'NO';
        }

        if (canFulfillSlot || canFulfillSlot === 'YES') {
            canFulfillSlot = 'YES';
        } else {
            canFulfillSlot = 'NO';
        }
