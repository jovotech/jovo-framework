...
const CanHandleIntentRequest = require('../canHandleIntentRequest').CanHandleIntentRequest;
...
class RequestParser {
    ...
    static createRequest(request) {
        ...
        } else if (type === 'CanHandleIntentRequest') {
            return new CanHandleIntentRequest(request);
