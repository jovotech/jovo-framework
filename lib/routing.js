...
class Routing {
    ...
    isCanFulfillIntentRequest() {
        return this.jovo.getPlatform().getRequestType() === BaseApp.REQUEST_TYPE_ENUM.CAN_FULFILL_INTENT;
    }
    /**
    ...
    /**
     * Handles all can fulfill intent requests
     * Calls handler function for CAN_FULFILL_INTENT
     * @private
     */
