...
class Db {
    ...
    * @param {object} config The config for the database. config.type will be used to determine the implementation.
    ...
    */
    static createInstance(config) {
      ...
      var creatorFunction = Db.dbIntegrations[config.type];
      ...
      try {
        var dbInstance = new Db(config.type, creatorFunction(config));
        return dbInstance;
      } catch (e) {
