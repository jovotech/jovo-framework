 ...
 * Currently only supports projectId and apiEndpoint as config parameter, the rest hsould be handled by ENV variables.
 */
class DatastoreDb {
    /**
     * constructor
    ...
    saveFullObject(key, value, callback) {
      ...
      var entityKey = this.datastore.key([this.entity, this.mainKey]);
...
function createError(code, mainKey, key = undefined) {
