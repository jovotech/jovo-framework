            ...
            if (this.options.requestLogging) {
                ...
                if (this.record) {
                    ...
                    if (requestObj.originalRequest && requestObj.originalRequest.source === 'google') {
                        // request is google action based
                        if (requestObj.originalRequest.data.conversation.type === 'NEW') {
                            this.googleActionIndex = 0;
                        } else {
                            this.googleActionIndex++;
                        ...
                        if (requestObj.session.new === true) {
                            this.alexaIndex = 0;
                    ...
                    let sessionPath = `.${path.sep}test${path.sep}helper${path.sep}` +
                        `session_${this.recordingName ? this.recordingName : this.sessionId}` +
