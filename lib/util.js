...
module.exports.getPlatformType = function (requestObj) {
    if (requestObj.request && ((requestObj.request.originalRequest && requestObj.request.originalRequest.source === 'google') ||
        (requestObj.request.originalDetectIntentRequest && requestObj.request.originalDetectIntentRequest.source === 'google'))) {
        if (requestObj.request.responseId) {
            return BaseApp.PLATFORM_ENUM.GOOGLE_ACTION_V2;
        } else {
...
module.exports.getRequestType = function(requestObj) {
    ...
    if (platform === BaseApp.PLATFORM_ENUM.ALEXA_SKILL) {
        return platform;
    } else if (platform === BaseApp.PLATFORM_ENUM.GOOGLE_ACTION || platform === BaseApp.PLATFORM_ENUM.GOOGLE_ACTION_V2) {
...
module.exports.makeRequestInstance = function(requestObj) {
    ...
    if (module.exports.getPlatformType(requestObj) === BaseApp.PLATFORM_ENUM.GOOGLE_ACTION || module.exports.getPlatformType(requestObj) === BaseApp.PLATFORM_ENUM.GOOGLE_ACTION_V2) {
