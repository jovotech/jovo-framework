...
var DatastoreDb = require('../app/patches/datastore.js').DatastoreDb;
...
describe('Datastore jovo Connector', function() {
  ...
  it('should load the same value', function(done) {
  ...
  it('should save a object with a special key', function(done) {
