...
describe('playback controller requests', function() {
    it('should return PlaybackController.PlayCommandIssued handler', function(done) {
        let app = new App();

        let request = RequestBuilderAlexaSkill
            .audioPlayerRequest()
            .setType('PlaybackController.PlayCommandIssued');
    ...
    it('should return PlaybackController.NextCommandIssued handler', function(done) {
        let app = new App();
        let request = RequestBuilderAlexaSkill
            .audioPlayerRequest()
            .setType('PlaybackController.NextCommandIssued');
    ...
    it('should return PlaybackController.PreviousCommandIssued handler', function(done) {
        let app = new App();

        let request = RequestBuilderAlexaSkill
            .audioPlayerRequest()
            .setType('PlaybackController.PreviousCommandIssued');
