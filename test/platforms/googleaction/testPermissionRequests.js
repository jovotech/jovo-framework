...
const permissionGrantedNameRequestSample = require('../../../lib/platforms/googleaction/request/samples/actions/permissionGrantedNameRequest');
const permissionGrantedPreciseLocationRequestSample = require('../../../lib/platforms/googleaction/request/samples/actions/permissionGrantedPreciseLocationRequest');
const permissionGrantedCoarseLocationRequestSample = require('../../../lib/platforms/googleaction/request/samples/actions/permissionGrantedCoarseLocationRequest');
const permissionGrantedNameAndLocationRequestSample = require('../../../lib/platforms/googleaction/request/samples/actions/permissionGrantedNameAndLocationRequest');

const permissionNotGrantedRequestSample = require('../../../lib/platforms/googleaction/request/samples/actions/permissionNotGrantedRequest');
