...
describe('googleAction()', function() {
    it('should return null because request is from alexa', function() {
        ...
        assert(app.googleAction() === null, 'googleAction() returns null');
    });
    it('should be type of object', function() {
        ...
        assert(typeof app.googleAction() === 'object', 'typeof object');
    });

    it('should return ALEXA_SKILL as platformtype', function() {
        let app = new Jovo.Jovo();
        ...
        assert(app.googleAction().getType() === Jovo.PLATFORM_ENUM.GOOGLE_ACTION, 'GOOGLE_ACTION');
    });
});
