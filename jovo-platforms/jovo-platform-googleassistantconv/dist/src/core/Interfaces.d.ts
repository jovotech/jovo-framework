...
export declare type SlotFillingStatus = 'UNSPECIFIED' | 'INITIALIZED' | 'COLLECTING' | 'FINALIZING' | 'FINAL';
export declare type SlotMode = 'MODE_UNSPECIFIED' | 'OPTIONAL' | 'REQUIRED';
export declare type SlotStatus = 'SLOT_UNSPECIFIED' | 'EMPTY' | 'INVALID' | 'FILLED';
export declare type HorizontalAlignment = 'UNSPECIFIED' | 'LEADING' | 'CENTER' | 'TRAILING';
export declare type ImageFill = 'UNSPECIFIED' | 'GRAY' | 'WHITE' | 'CROPPED';
export declare type UrlHint = 'LINK_UNSPECIFIED' | 'AMP';
export declare type MediaType = 'MEDIA_TYPE_UNSPECIFIED' | 'AUDIO' | 'MEDIA_STATUS_ACK';
export declare type OptionalMediaControls = 'OPTIONAL_MEDIA_CONTROLS_UNSPECIFIED' | 'PAUSED' | 'STOPPED' | 'NEXT' | 'PREVIOUS';
export declare type TypeOverrideMode = 'TYPE_UNSPECIFIED' | 'TYPE_REPLACE' | 'TYPE_MERGE';
export declare type Capability = 'UNSPECIFIED' | 'SPEECH' | 'RICH_RESPONSE' | 'LONG_FORM_AUDIO' | 'INTERACTIVE_CANVAS' | 'WEB_LINK' | 'HOME_STORAGE';
export declare type AccountLinkingStatus = 'ACCOUNT_LINKING_STATUS_UNSPECIFIED' | 'NOT_LINKED' | 'LINKED';
export declare type UserVerificationStatus = 'USER_VERIFICATION_STATUS_UNSPECIFIED' | 'GUEST' | 'VERIFIED';
export declare type SkuType = 'SKU_TYPE_UNSPECIFIED' | 'SKU_TYPE_IN_APP' | 'SKU_TYPE_SUBSCRIPTION' | 'APP';
...
export declare type PresentationRequirement = 'REQUIREMENT_UNSPECIFIED' | 'REQUIREMENT_OPTIONAL' | 'REQUIREMENT_REQUIRED';
...
export declare type CompletePurchaseType = 'PURCHASE_STATUS_OK' | 'PURCHASE_STATUS_ALREADY_OWNED' | 'PURCHASE_STATUS_ITEM_UNAVAILABLE' | 'PURCHASE_STATUS_ITEM_CHANGE_REQUESTED' | 'PURCHASE_STATUS_USER_CANCELLED' | 'PURCHASE_STATUS_ERROR' | 'PURCHASE_STATUS_UNSPECIFIED';
...
export declare type MoneyType = 'TYPE_UNSPECIFIED' | 'REGULAR' | 'DISCOUNT' | 'TAX' | 'DELIVERY' | 'SUBTOTAL' | 'FEE' | 'GRATUITY' | 'TOTAL';
export declare type PurchaseLocationType = 'UNSPECIFIED_LOCATION' | 'ONLINE_PURCHASE' | 'INSTORE_PURCHASE';
export declare type ErrorType = 'ERROR_TYPE_UNSPECIFIED' | 'NOT_FOUND' | 'INVALID' | 'AVAILABILITY_CHANGED' | 'PRICE_CHANGED' | 'INCORRECT_PRICE' | 'REQUIREMENTS_NOT_MET' | 'TOO_LATE' | 'NO_CAPACITY' | 'NO_COURIER_AVAILABLE' | 'INELIGIBLE' | 'OUT_OF_SERVICE_AREA' | 'CLOSED' | 'PROMO_NOT_APPLICABLE' | 'PROMO_NOT_RECOGNIZED' | 'PROMO_EXPIRED' | 'PROMO_USER_INELIGIBLE' | 'PROMO_ORDER_INELIGIBLE' | 'UNAVAILABLE_SLOT' | 'FAILED_PRECONDITION' | 'PAYMENT_DECLINED' | 'MERCHANT_UNREACHABLE' | 'ACCOUNT_LINKING_FAILED';
export declare type TransactionDecisionType = 'ORDER_ACCEPTED' | 'ORDER_REJECTED' | 'CART_CHANGE_REQUESTED' | 'USER_CANNOT_TRANSACT';
export declare type TransactionDeliveryAddressUserDecisionType = 'ACCEPTED' | 'REJECTED' | string;
export declare type EventType = 'EVENT_TYPE_UNKNOWN' | 'MOVIE' | 'CONCERT' | 'SPORTS';
export declare type PermissionStatus = 'PERMISSION_DENIED' | 'PERMISSION_GRANTED' | 'ALREADY_GRANTED';
export declare type CharacterType = 'TYPE_UNKNOWN' | 'ACTOR' | 'PERFORMER' | 'DIRECTOR' | 'ORGANIZER';
...
export interface IntentParameterValue {
    original: string;
    resolved: string | PermissionResult | TransactionRequirementsCheckResult | TransactionDecisionResult | TransactionDeliveryAddressResult | TransactionDigitalPurchaseCheckResult | TransactionDigitalPurchaseCompleteResult;
}
...
export declare type RequirementsCheckResultType = 'USER_ACTION_REQUIRED' | 'OK' | 'CAN_TRANSACT' | 'ASSISTANT_SURFACE_NOT_SUPPORTED' | 'REGION_NOT_SUPPORTED';
export declare type DigitalPurchaseCheckResultType = 'CAN_PURCHASE' | 'CANNOT_PURCHASE' | string;
...
export declare type Reprompt = string | SpeechBuilder;
