export declare type EntryPoint = 'ENTRY_POINT_UNSPECIFIED' | 'PLACESHEET' | 'MAPS';
...
export declare type SuggestionType = 'UNKNOWN' | 'ACTION' | 'REPLY';
...
export declare type RepresentativeType = 'REPRESENTATIVE_TYPE_UNSPECIFIED' | 'BOT' | 'HUMAN';
...
export declare type Suggestion = SuggestedReply | SuggestActionUrl | SuggestActionDial;
...
export declare type CardWidth = 'CARD_WIDTH_UNSPECIFIED' | 'SMALL' | 'MEDIUM';
export declare type CardHeight = 'HEIGHT_UNSPECIFIED' | 'SHORT' | 'MEDIUM' | 'TALL';
