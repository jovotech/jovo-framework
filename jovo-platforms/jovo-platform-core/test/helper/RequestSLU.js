...
var RequestSLU = /** @class */ (function () {
    function RequestSLU() {
        this.config = {};
    }
    RequestSLU.prototype.install = function (corePlatform) {
        corePlatform.middleware('$nlu').use(this.nlu.bind(this));
        corePlatform.middleware('$inputs').use(this.inputs.bind(this));
    };
    RequestSLU.prototype.uninstall = function (corePlatform) {
    };
    RequestSLU.prototype.nlu = function (corePlatformApp) {
        return __awaiter(this, void 0, void 0, function () {
            var assistantRequest, intentName;
            return __generator(this, function (_a) {
                console.log('[RequestSLU] ( $nlu )');
                assistantRequest = corePlatformApp.$request;
    ...
    RequestSLU.prototype.inputs = function (corePlatformApp) {
        return __awaiter(this, void 0, void 0, function () {
            var corePlatformtRequest;
            return __generator(this, function (_a) {
                console.log('[RequestSLU] ( $inputs )');
                corePlatformtRequest = corePlatformApp.$request;
                ...
                else if (corePlatformApp.$type.type === jovo_core_1.EnumRequestType.LAUNCH || corePlatformApp.$type.type === jovo_core_1.EnumRequestType.END) {
