...
import { EventSkillAccountLinkedBody, EventSkillDisabledBody, EventSkillEnabledBody, EventSkillPermissionAcceptedBody } from './modules/SkillEvent';
...
declare module './core/AlexaSkill' {
    interface AlexaSkill {
        getBody(): any;
        getSkillEventBody(): EventSkillAccountLinkedBody | EventSkillEnabledBody | EventSkillDisabledBody | EventSkillPermissionAcceptedBody | any;
    }
}
declare module './core/AlexaSkill' {
    interface AlexaSkill {
