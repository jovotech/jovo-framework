...
const BodyTemplate1_1 = require("../../src/response/visuals/BodyTemplate1");
const Template_1 = require("../../src/response/visuals/Template");
const BodyTemplate2_1 = require("../../src/response/visuals/BodyTemplate2");
const BodyTemplate3_1 = require("../../src/response/visuals/BodyTemplate3");
const BodyTemplate6_1 = require("../../src/response/visuals/BodyTemplate6");
const BodyTemplate7_1 = require("../../src/response/visuals/BodyTemplate7");
const ListTemplate1_1 = require("../../src/response/visuals/ListTemplate1");
const ListTemplate2_1 = require("../../src/response/visuals/ListTemplate2");
const ListTemplate3_1 = require("../../src/response/visuals/ListTemplate3");
process.env.NODE_ENV = 'TEST';
class TemplateImpl extends Template_1.Template {
    constructor() {
        super('TemplateImpl');
    }
}
...
test('test makeRichText', () => {
    expect(Template_1.Template.makeRichText('Foo')).toEqual({
        type: 'RichText',
        text: 'Foo',
    });
    const richText = {
    ...
    expect(Template_1.Template.makeRichText(richText)).toEqual(richText);
});
test('test makePlainText', () => {
    expect(Template_1.Template.makePlainText('Foo')).toEqual({
        type: 'PlainText',
        text: 'Foo',
    });
    const plainText = {
    ...
    expect(Template_1.Template.makePlainText(plainText)).toEqual(plainText);
});
test('test makeTextContent', () => {
    expect(Template_1.Template.makeTextContent('Foo')).toEqual({
        primaryText: {
            type: 'RichText',
            text: 'Foo',
        },
    });
    expect(Template_1.Template.makeTextContent({
        type: 'RichText',
        text: 'Foo',
    })).toEqual({
        primaryText: {
    ...
    // with secondaryText
    expect(Template_1.Template.makeTextContent('Foo', 'Bar')).toEqual({
        primaryText: {
            type: 'RichText',
            text: 'Foo',
        },
    ...
    // with tertiaryText
    expect(Template_1.Template.makeTextContent('Foo', 'Bar', 'FooBar')).toEqual({
        primaryText: {
            type: 'RichText',
            text: 'Foo',
        },
...
test('test makeImage', () => {
    expect(Template_1.Template.makeImage('url')).toEqual({
        sources: [
            {
                url: 'url',
            },
    ...
    expect(Template_1.Template.makeImage('url', 'description')).toEqual({
    ...
    // ImageShort object
    expect(Template_1.Template.makeImage({ url: 'url' })).toEqual({
        sources: [
            {
                url: 'url',
            },
    ...
    expect(Template_1.Template.makeImage({ url: 'url', description: 'description' })).toEqual({
        contentDescription: 'description',
        sources: [
            {
                url: 'url',
    ...
    // Image object
    expect(Template_1.Template.makeImage({
        contentDescription: 'description',
        sources: [
            {
                url: 'url',
...
test('test BodyTemplate1', () => {
    const bodyTemplate1 = new BodyTemplate1_1.BodyTemplate1();
...
test('test BodyTemplate2', () => {
    const bodyTemplate2 = new BodyTemplate2_1.BodyTemplate2();
...
test('test BodyTemplate3', () => {
    const bodyTemplate3 = new BodyTemplate3_1.BodyTemplate3();
...
test('test BodyTemplate6', () => {
    const bodyTemplate6 = new BodyTemplate6_1.BodyTemplate6();
...
test('test BodyTemplate7', () => {
    const bodyTemplate7 = new BodyTemplate7_1.BodyTemplate7();
...
test('test ListTemplate1', () => {
    const listTemplate1 = new ListTemplate1_1.ListTemplate1();
...
test('test ListTemplate2', () => {
    ...
    const listTemplate2 = new ListTemplate2_1.ListTemplate2();
...
test('test ListTemplate3', () => {
    // same test as in ListTemplate 1
    const listTemplate3 = new ListTemplate3_1.ListTemplate3();
    listTemplate3.addItem('token', { contentDescription: 'desc', sources: [{ url: 'image_url' }] }, 'primaryText', 'secondaryText', 'tertiaryText');
...
//# sourceMappingURL=RenderTemplates.test.js.map