...
const AlexaSpeechBuilder_1 = require("../src/core/AlexaSpeechBuilder");
test('test audio tag', () => {
    const jovo = {};
    // @ts-ignore
    const sb = new AlexaSpeechBuilder_1.AlexaSpeechBuilder(jovo);
...
test('test lang tag with array', () => {
    ...
    expect(sb.toString()).toMatch(/^(<lang xml:lang=\"de\">Hallo<\/lang>|<lang xml:lang=\"de\">Guten Tag<\/lang>)/);
});
test('test voice tag', () => {
    const jovo = {};
    // @ts-ignore
...
test('test voice tag with array', () => {
    ...
    expect(sb.toString()).toMatch(/^(<voice name=\"Hans\">Hallo<\/voice>|<voice name=\"Hans\">Guten Tag<\/voice>)/);
});
//# sourceMappingURL=AlexaSpeechBuilder.test.js.map