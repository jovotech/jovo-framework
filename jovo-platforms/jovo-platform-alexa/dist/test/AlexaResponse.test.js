...
const AlexaResponse_1 = require("../src/core/AlexaResponse");
...
test('test getReprompt', () => {
    const tellResponse = AlexaResponse_1.AlexaResponse.fromJSON(_cloneDeep(tellJSON));
    expect(tellResponse.getReprompt()).toBeUndefined();
    const askResponse = AlexaResponse_1.AlexaResponse.fromJSON(_cloneDeep(askJSON));
    expect(askResponse.getReprompt()).toBe('Simple Ask Reprompt');
});
test('test getDirectives', () => {
    const directivesResponse = AlexaResponse_1.AlexaResponse.fromJSON(_cloneDeep(directivesJSON));
...
test('test hasState', () => {
    const responseWithState = AlexaResponse_1.AlexaResponse.fromJSON(_cloneDeep(askJSON));
    ...
    const responseWithoutState = AlexaResponse_1.AlexaResponse.fromJSON(_cloneDeep(tellJSON));
...
test('test hasSimpleCard', () => {
    const simpleCardResponse = AlexaResponse_1.AlexaResponse.fromJSON(_cloneDeep(simpleCard));
...
test('test hasStandardCard', () => {
    const standardCardResponse = AlexaResponse_1.AlexaResponse.fromJSON(_cloneDeep(standardCard));
    ...
    expect(standardCardResponse.hasStandardCard('Standard Title', 'Standard Text', 'https://via.placeholder.com/720x480')).toBe(true);
    expect(standardCardResponse.hasStandardCard('Standard Title', 'Standard Text', 'https://via.placeholder.com/')).toBe(false);
    expect(standardCardResponse.hasStandardCard('Standard Title', 'Standard Text', 'https://via.placeholder.com/720x480', 'https://via.placeholder.com/1200x800')).toBe(true);
    expect(standardCardResponse.hasStandardCard('Standard Title', 'Standard Text', 'https://via.placeholder.com/', 'https://via.placeholder.com/')).toBe(false);
    const askResponse = AlexaResponse_1.AlexaResponse.fromJSON(_cloneDeep(askJSON));
    expect(askResponse.hasStandardCard()).toBe(false);
});
test('test hasLinkAccountCard', () => {
    const linkAccountResponse = AlexaResponse_1.AlexaResponse.fromJSON(_cloneDeep(linkAccountCard));
...
test('test hasAskForAddressCard', () => {
    const fullAddressResponse = AlexaResponse_1.AlexaResponse.fromJSON(_cloneDeep(fullAddressCard));
    expect(fullAddressResponse.hasAskForAddressCard()).toBe(true);
    const countryPostalResponse = AlexaResponse_1.AlexaResponse.fromJSON(_cloneDeep(countryPostalCard));
...
//# sourceMappingURL=AlexaResponse.test.js.map