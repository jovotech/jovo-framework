...
export class GameEngine {
   ...
   */
  // tslint:disable-next-line
  setRecognizers(recognizerArray: any[]) {
   ...
   */
  // tslint:disable-next-line
  startInputHandler(timeout: number, proxies: any[], recognizers: any[], events: any[]) {
...
class GameEngineStartInputHandlerDirective extends GameEngineDirective {
  ...
  events: any[]; // tslint:disable-line
  // tslint:disable-next-line
  constructor(timeout: number, proxies: any[], recognizers: any[], events: any[]) {
