...
const GoogleActionResponse_1 = require("../src/core/GoogleActionResponse");
...
test('test getCard', () => {
    const responseWithState = GoogleActionResponse_1.GoogleActionResponse.fromJSON(_cloneDeep(askJSON));
    ...
    const responseWithoutState = GoogleActionResponse_1.GoogleActionResponse.fromJSON(_cloneDeep(tellJSON));
...
test('test hasImageCard', () => {
    ...
    const imageCardResponse = GoogleActionResponse_1.GoogleActionResponse.fromJSON(_cloneDeep(imageCardJSON));
...
test('test hasSuggestionChips', () => {
    ...
    expect(responseWithState.hasSuggestionChips('Suggestion 1', 'Suggestion 2', 'Suggestion 3', 'Suggestion 4', 'Suggestion 5', 'Suggestion 6', 'Suggestion 7', 'Suggestion 8')).toBe(true);
    expect(responseWithState.hasSuggestionChips('Suggestion 1', 'Suggestion 2', 'Suggestion 3', 'Suggestion 4', 'Test123', 'Suggestion 6', 'Suggestion 7', 'Suggestion 8')).toBe(false);
    const responseWithoutState = GoogleActionResponse_1.GoogleActionResponse.fromJSON(_cloneDeep(tellJSON));
...
//# sourceMappingURL=GoogleActionResponse.test.js.map