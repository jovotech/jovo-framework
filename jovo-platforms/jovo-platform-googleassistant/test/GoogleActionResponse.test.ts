...
test('test hasImageCard', () => {
  ...
  expect(
    responseWithState.hasImageCard('Sample Card Title', 'Sample Card Content', 'www.image.com'),
  ).toBe(false);
  ...
  expect(
    imageCardResponse.hasImageCard('Sample Card Title', 'Sample Card Content', 'www.image.com'),
  ).toBe(true);
  expect(
    imageCardResponse.hasImageCard('Sample Card Title', 'Sample Card Content', 'www.jovo.com'),
  ).toBe(false);
});
...
test('test hasSuggestionChips', () => {
  ...
  expect(responseWithState.hasSuggestionChips('Suggestion 1', 'Suggestion 2', 'Suggestion 3')).toBe(
    true,
  );
  expect(responseWithState.hasSuggestionChips('Suggestion 1', 'test123', 'Suggestion 3')).toBe(
    false,
  );

  expect(
    responseWithState.hasSuggestionChips(
      'Suggestion 1',
      'Suggestion 2',
      'Suggestion 3',
      'Suggestion 4',
...
test('test hasMediaResponse', () => {
  ...
  expect(
    responseWithState.hasMediaResponse('https://www.url.to/file.mp3', 'Sample Jovo Content'),
  ).toBe(false);
