...
export class GoogleAssistantDialogflowFactory implements PlatformFactory {
  ...
  createRequest(json: DialogflowRequestJSON): DialogflowRequest {
    ...
    dialogflowRequest.originalDetectIntentRequest!.payload = GoogleActionRequest.fromJSON(
      dialogflowRequest.originalDetectIntentRequest!.payload as GoogleActionRequestJSON,
    );
