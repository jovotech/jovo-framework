...
export declare const NEW_SESSION_KEY = "__JOVO_NEW_SESSION__";
...
declare module 'jovo-core/dist/src/Interfaces' {
    interface AppPlatformConfig extends AppSapCaiConfig {
    }
    interface ExtensiblePluginConfigs extends AppSapCaiConfig {
    }
}
