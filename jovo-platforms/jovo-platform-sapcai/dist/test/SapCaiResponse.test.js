...
const SapCaiResponse_1 = require("../src/core/SapCaiResponse");
...
test('test getReprompt', () => {
    const tellResponse = SapCaiResponse_1.SapCaiResponse.fromJSON(_cloneDeep(tellJSON));
...
test('test hasState', () => {
    const responseWithState = SapCaiResponse_1.SapCaiResponse.fromJSON(_cloneDeep(askJSON));
    ...
    const responseWithoutState = SapCaiResponse_1.SapCaiResponse.fromJSON(_cloneDeep(tellJSON));
...
test('test hasStandardCard', () => {
    const standardCardResponse = SapCaiResponse_1.SapCaiResponse.fromJSON(_cloneDeep(askJSON));
    ...
    expect(standardCardResponse.hasStandardCard('Standard Title', 'Standard Text', 'https://via.placeholder.com/1200x800')).toBe(true);
    expect(standardCardResponse.hasStandardCard('Standard Title', 'Standard Text', 'https://via.placeholder.com/')).toBe(false);
    expect(standardCardResponse.hasStandardCard('Standard Title', 'Standard Text', 'https://via.placeholder.com/1200x800')).toBe(true);
    const askResponse = SapCaiResponse_1.SapCaiResponse.fromJSON(_cloneDeep(tellJSON));
...
test('test hasQuickResponseCard', () => {
    ...
    expect(responseWithState.hasQuickReplyCard('Quick Reply Test', 'QR button 1 title', 'QR button 2 title', 'QR button 3 title', 'QR button 4 title')).toBe(true);
    expect(responseWithState.hasQuickReplyCard('Quick Reply Test', 'QR button 1 title', 'QR button 2 title', 'Test123', 'QR button 3 title')).toBe(false);
    const responseWithoutState = SapCaiResponse_1.SapCaiResponse.fromJSON(_cloneDeep(tellJSON));
...
test('test hasButtonsCard', () => {
    ...
    expect(responseWithState.hasButtonsCard('Button List', 'BL button 1 title', 'BL button 2 title', 'BL button 3 title', 'BL button 4 title')).toBe(true);
    expect(responseWithState.hasButtonsCard('Button List', 'BL button 1 title', 'BL button 2 title', 'Test123', 'BL button 3 title')).toBe(false);
    const responseWithoutState = SapCaiResponse_1.SapCaiResponse.fromJSON(_cloneDeep(tellJSON));
...
test('test hasImageCard', () => {
    ...
    const imageCardResponse = SapCaiResponse_1.SapCaiResponse.fromJSON(_cloneDeep(tellJSON));
    expect(imageCardResponse.hasImageCard()).toBe(false);
});
//# sourceMappingURL=SapCaiResponse.test.js.map