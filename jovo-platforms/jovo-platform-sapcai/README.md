[![Jovo Framework](https://github.com/jovotech/jovo-framework/raw/master/docs/img/jovo-header.png)](https://www.jovo.tech)
...
# SAP CAI Platform Integration

```sh
npm install jovo-platform-sapcai
```

Find the docs here: https://www.jovo.tech/docs/sap-cai
