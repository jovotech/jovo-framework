import { SapCaiResponse } from '../src/core/SapCaiResponse';
...
test('test hasStandardCard', () => {
  ...
  expect(
    standardCardResponse.hasStandardCard(
      'Standard Title',
      'Standard Text',
...
test('test hasQuickResponseCard', () => {
  ...
  expect(
    responseWithState.hasQuickReplyCard(
      'Quick Reply Test',
      'QR button 1 title',
      'QR button 2 title',
    ),
  ...
  expect(
    responseWithState.hasQuickReplyCard('Quick Reply Test', 'test123', 'QR button 2 title'),
  ).toBe(false);
...
test('test hasButtonsCard', () => {
  ...
  expect(
    responseWithState.hasButtonsCard('Button List', 'BL button 1 title', 'BL button 2 title'),
  ).toBe(true);
  expect(responseWithState.hasButtonsCard('Button List', 'test123', 'BL button 2 title')).toBe(
    false,
  );

  expect(
    responseWithState.hasButtonsCard(
      'Button List',
      'BL button 1 title',
      'BL button 2 title',
      'BL button 3 title',
...
test('test getCarouselCard', () => {
  ...
  expect(quickReplies.content[0].imageUrl).toMatch(
...
test('test hasCarouselCard', () => {
  ...
  expect(
    responseWithState.hasCarouselCard({
  ...
  const responseWithoutState = SapCaiResponse.fromJSON(_cloneDeep(tellJSON));
  expect(
    responseWithoutState.hasCarouselCard({
      title: 'Carousel title 1',
      subtitle: 'Carousel Subtitle 1',
      imageUrl: 'https://materializecss.com/images/sample-1.jpg',
    }),
...
test('test getListCard', () => {
  ...
  expect(quickReplies.content.elements[0].imageUrl).toMatch(
    'https://materializecss.com/images/sample-1.jpg',
  );
...
test('test hasListCard', () => {
  ...
  const responseWithoutState = SapCaiResponse.fromJSON(_cloneDeep(tellJSON));
  expect(
    responseWithoutState.hasListCard([
      {
        title: 'List title 1',
        subtitle: 'List Subtitle 1',
        imageUrl: 'https://materializecss.com/images/404.jpg',
...
test('test hasImageCard', () => {
  ...
  expect(
    responseWithState.hasImageCard('https://materializecss.com/images/showcase/varun_malhotra.jpg'),
  ).toBe(true);
  expect(
    responseWithState.hasImageCard('Shttps://materializecss.com/images/showcase/404.jpg'),
  ).toBe(false);
