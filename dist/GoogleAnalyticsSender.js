...
class GoogleAnalyticsSender {
    ...
    throwJovoNotSetError() {
        throw new jovo_core_1.JovoError("Could not make GooleAnalytics avaiable to skill.", jovo_core_1.ErrorCode.ERR_PLUGIN, 'jovo-analytics-googleanalytics', "Jovo Instance was not available", "Contact admin. ");
    }
    /**
    ...
    initVisitor() {
        if (this.jovo) {
            ...
            if (this.jovo.isAlexaSkill()) {
                ...
                const alexaRequest = this.jovo.$request;
