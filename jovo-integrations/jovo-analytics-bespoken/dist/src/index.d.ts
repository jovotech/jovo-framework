...
declare module 'jovo-core/dist/src/Interfaces' {
    interface AppAnalyticsConfig extends AppBespokenConfig {
    }
    interface ExtensiblePluginConfigs extends AppBespokenConfig {
    }
}
export { BespokenAlexa, Config as AlexaConfig } from './BespokenAlexa';
export { BespokenGoogleAssistant, Config as GoogleAssistantConfig, } from './BespokenGoogleAssistant';
