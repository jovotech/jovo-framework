...
test('test 403 ERROR', async () => {
    ...
    const result = AlexaSettings.settingsAPI(AlexaSettings.TEMPERATURE_UNITS,
        'apiEndPoint',
        'permissionToken',
        'deviceId');
    expect(
...
test('test Timezone', async () => {
    ...
    expect(
        AlexaSettings.settingsAPI(AlexaSettings.TIMEZONE,
            'apiEndPoint',
            'permissionToken',
            'deviceId'))
...
test('test Distance Units', async () => {
    ...
    expect(
        AlexaSettings.settingsAPI(AlexaSettings.DISTANCE_UNITS,
            'apiEndPoint',
            'permissionToken',
            'deviceId'))
...
test('test Temperature Units', async () => {
    ...
    expect(
        AlexaSettings.settingsAPI(AlexaSettings.TEMPERATURE_UNITS,
            'apiEndPoint',
            'permissionToken',
            'deviceId'))
