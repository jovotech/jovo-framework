...
declare module 'jovo-core/dist/src/Interfaces' {
    interface AppAnalyticsConfig extends AppChatbaseConfig {
    }
    interface ExtensiblePluginConfigs extends AppChatbaseConfig {
    }
}
export { ChatbaseAlexa, Config as AlexaConfig } from './ChatbaseAlexa';
export { ChatbaseGoogleAssistant, Config as GoogleAssistantConfig, } from './ChatbaseGoogleAssistant';
