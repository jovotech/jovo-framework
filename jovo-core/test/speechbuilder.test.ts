...
test('addText', () => {
  ...
  expect(speechBuilder6.toString()).toBe(
    '<prosody rate="fast"><emphasis level="moderate">text1</emphasis></prosody>',
  );
});
...
test('addPhoneme', () => {
  ...
  expect(speechBuilder.toString()).toBe(
    '<phoneme alphabet="x-sampa" ph="&quot;kvo:t@">quote</phoneme>',
  );
...
test('test concatenation', () => {
  ...
  const expectedString =
    'Hello <break time="100ms"/> I am <say-as interpret-as="ordinal">20</say-as> years old';
