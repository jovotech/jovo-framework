...
test('test intentRoute', () => {
    ...
    const result1 = src_1.Router.intentRoute(jovo.$handlers, undefined, 'IntentA');
    expect(result1).toHaveProperty('path', 'IntentA');
    // state intent
    const result2 = src_1.Router.intentRoute(jovo.$handlers, 'State1', 'IntentB');
    expect(result2).toHaveProperty('path', 'State1.IntentB');
    // multiple state intent
    const result3 = src_1.Router.intentRoute(jovo.$handlers, 'State1.State2', 'IntentC');
    expect(result3).toHaveProperty('path', 'State1.State2.IntentC');
    // multiple state intent
    const result3b = src_1.Router.intentRoute(jovo.$handlers, 'State1.State2', 'IntentB');
    expect(result3b).toHaveProperty('path', 'State1["IntentB"]');
    // route of global IntentA
    const result4 = src_1.Router.intentRoute(jovo.$handlers, 'State1', 'IntentA');
...
test('test intentRoute() unhandled global', () => {
    ...
    const result1 = src_1.Router.intentRoute(jovo.$handlers, 'State1', 'IntentX');
...
test('test intentRoute() unhandled in state', () => {
    ...
    const result2 = src_1.Router.intentRoute(jovo.$handlers, 'State1', 'IntentX');
...
test('test intentRoute() unhandled without unhandled in handler ', () => {
    ...
    const result3 = src_1.Router.intentRoute(jovo.$handlers, 'State1', 'IntentX');
...
test('test intentRoute() intentsToSkipUnhandled ', () => {
    ...
    const result3 = src_1.Router.intentRoute(jovo.$handlers, 'State1', 'SkipIntent', ['SkipIntent']);
...
test('test intentRoute() Intents with dots', () => {
    ...
    const result1 = src_1.Router.intentRoute(jovo.$handlers, undefined, 'AMAZON.StopIntent');
    expect(result1).toHaveProperty('path', '["AMAZON.StopIntent"]');
    const result2 = src_1.Router.intentRoute(jovo.$handlers, 'State1', 'AMAZON.CancelIntent');
    expect(result2).toHaveProperty('path', 'State1["AMAZON.CancelIntent"]');
    const result3 = src_1.Router.intentRoute(jovo.$handlers, 'State1.State12', 'AMAZON.CancelIntent');
...
test('test intentRoute() Intents with dots', () => {
    ...
    const result1 = src_1.Router.intentRoute(jovo.$handlers, 'State1', 'IntentA', ['IntentB']);
    expect(result1).toHaveProperty('path', 'State1.Unhandled');
    const result2 = src_1.Router.intentRoute(jovo.$handlers, 'State1', 'IntentB', ['IntentB']);
...
describe('test mapIntentName()', () => {
    test('should map to END', () => {
        ...
        const result = src_1.Router.mapIntentName(appConfig, 'AMAZON.StopIntent');
    ...
    test(`shouldn't map to anything`, () => {
        ...
        const result = src_1.Router.mapIntentName(appConfig, 'AMAZON.CancelIntent');
    ...
    test(`should map using component's intentMap`, () => {
        ...
        }; // hack so we don't have to implement the full Component class, but just the parts we need
        const result = src_1.Router.mapIntentName(appConfig, 'AMAZON.StopIntent', component);
