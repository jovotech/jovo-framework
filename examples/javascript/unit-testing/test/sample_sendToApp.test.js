...
process.env.JOVO_CONFIG = __dirname + '/../src/config.js';
...
for (const p of [new Alexa(), new GoogleAssistant()]) {
    ...
    describe(`PLATFORM: ${p.constructor.name} INTENTS` , () => {
        test('should return a welcome message and ask for the name at "LAUNCH"', async () => {
            ...
            const responseLaunchRequest = await conversation.sendToApp(launchRequest, app);
        ...
        test('should return a welcome message and ask for the name at "HelloWorldIntent"', async () => {
            ...
            const responseIntentRequest = await conversation.sendToApp(intentRequest, app);
    ...
    describe(`PLATFORM: ${p.constructor.name} DATABASE` , () => {
        ...
        test('should update metaData', async () => {
            ...
            const responseIntentRequest2 = await conversation.sendToApp(intentRequest2, app);
            expect(
