...
app.setHandler({
	...
	SimpleCardIntent() {
		return this.$alexaSkill!.showCard(
			new SimpleCard().setTitle('Title').setContent('Content')
		).tell('Simple Card');
	},
	StandardCardIntent() {
		return this.$alexaSkill!.showCard(
	...
	AccountLinkingCard() {
		...
		// or
		return this.$alexaSkill!.showCard(new LinkAccountCard()).tell(
			'AccountLinking Card'
		);
	},
	AskForCountryAndPostalCodeCardIntent() {
		return this.$alexaSkill!.showAskForCountryAndPostalCodeCard().tell(
			'This is a card that asks for country and postal code permissions.'
		);
	},
	AskForAddressCardIntent() {
		return this.$alexaSkill!.showAskForAddressCard().tell(
			'This is a card that asks for address permissions.'
		);
	},
	...
	AskForPermissionConsentCardIntent() {
		this.$alexaSkill!.showAskForPermissionsCard([
