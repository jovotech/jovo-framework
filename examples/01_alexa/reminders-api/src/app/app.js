...
app.setHandler({
    ...
    async AddRelativeReminderIntent() {
        try {
            ...
            const result = await this.$user.setReminder(reminderRelative);
    ...
    async AddAbsoluteReminderIntent() {
        try {
            ...
            const result = await this.$user.setReminder(reminderAbsolute);
    ...
    async AllRemindersIntent() {
        const data = await this.$user.getAllReminders();
    ...
    async UpdateReminderIntent() {
        try {
            ...
            const data = await this.$user.updateReminder(alertToken, updatedAbsoluteReminder);
    ...
    async DeleteReminderIntent() {
        try {
            ...
            const data = await this.$user.deleteReminder(alertToken);
