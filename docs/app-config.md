...
- `app.dev.ts`: Configurations for local development ([FileDb](https://v4.jovo.tech/marketplace/db-filedb), [Express server](https://v4.jovo.tech/marketplace/server-express) and the [Jovo Debugger](https://v4.jovo.tech/docs/debugger))
...
For example, most Jovo projects include an `app.dev.ts` file that comes with specific configuration for local development ([FileDb](https://v4.jovo.tech/marketplace/db-filedb), [Express server](https://v4.jovo.tech/marketplace/server-express) and the [Jovo Debugger](https://v4.jovo.tech/docs/debugger)).
