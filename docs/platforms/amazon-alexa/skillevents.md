...
Find a detailed description of the `Proactive Subscription Changed` event [here](./proactive-events.md#skill-event---proactivesubscriptionchanged './proactive-events#skill-event---proactivesubscriptionchange')
